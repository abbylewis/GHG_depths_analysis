...
lat <- metadata %>%
  ...
  scale_y_continuous(breaks = c(70,50,30,10,-10,-30,-50,-70)) +
  theme_classic() +
  theme(
    axis.title.x = element_text(vjust = 15.5, margin = margin(t = 0)),
    axis.text.x = element_text(angle = 30, hjust = 1),
...
map2 <- map + theme(plot.margin = unit(c(70, 5.5, 1.5, 30), "pt"))
full <- map2 %>%
  ggdraw() +
  draw_plot(usa,
    x = -0.01,
