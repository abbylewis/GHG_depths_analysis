...
median(layer_sum_stats$Depth_m[layer_sum_stats$Layer == "bot"]/
         layer_sum_stats$MaximumDepth_m[layer_sum_stats$Layer == "bot"],
       na.rm = T)
sd(layer_sum_stats$Depth_m[layer_sum_stats$Layer == "bot"]/
         layer_sum_stats$MaximumDepth_m[layer_sum_stats$Layer == "bot"],
       na.rm = T)
min(layer_sum_stats$Depth_m[layer_sum_stats$Layer == "bot"]/
         layer_sum_stats$MaximumDepth_m[layer_sum_stats$Layer == "bot"],
    na.rm = T)
```
